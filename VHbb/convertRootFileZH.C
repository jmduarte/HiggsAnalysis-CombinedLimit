...
void convertRootFileZH(TString sigName = "Wh_125p6_0P", TString sigAltName = "Wh_125p6_0M", double altMu=-1.0, 
  ...
  bad.push_back("JEC");
  good.push_back("CMS_vhbb_zh_scale_j");
  bad.push_back("JER");
  good.push_back("CMS_vhbb_zh_res_j");
  bad.push_back("btag");
  good.push_back("CMS_vhbb_zh_eff_b");
  bad.push_back("mistag");
  good.push_back("CMS_vhbb_zh_FakeRate_b");
