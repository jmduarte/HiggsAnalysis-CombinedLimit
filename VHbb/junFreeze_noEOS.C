...
void junFreeze_noEOS(){
  ...
  g_VVVh_CMS_common_observed.file_name = "/uscms_data/d2/kreis/junFreeze/VVVh_CMS_common_observed_minuit_0p001_tries5_strategy1.combine.root";
  g_VVVh_CMS_common_observed.kill.push_back(0.13);
  g_VVVh_CMS_common_observed.kill.push_back(0.158);
  g_VVVh_CMS_common_observed.kill.push_back(0.21);
  g_VVVh_CMS_common_observed.kill.push_back(0.23);
  g_VVVh_CMS_common_observed.kill.push_back(0.33);
  g_VVVh_CMS_common_observed.kill.push_back(0.35);
  g_VVVh_CMS_common_observed.kill.push_back(0.79);
  g_VVVh_CMS_common_observed.kill.push_back(0.81);
  g_VVVh_CMS_common_observed.kill.push_back(0.89);
  g_VVVh_CMS_common_observed.kill.push_back(0.93);
  ...
  g_VVVh_CMS_common_observed_noScale.file_name = "/uscms_data/d2/kreis/junFreeze/VVVh_CMS_common_observed_minuit_0p001_tries5_strategy1.combine.root";
  g_VVVh_CMS_common_observed_noScale.kill.push_back(0.13);
  g_VVVh_CMS_common_observed_noScale.kill.push_back(0.158);
  g_VVVh_CMS_common_observed_noScale.kill.push_back(0.21);
  g_VVVh_CMS_common_observed_noScale.kill.push_back(0.23);
  g_VVVh_CMS_common_observed_noScale.kill.push_back(0.33);
  g_VVVh_CMS_common_observed_noScale.kill.push_back(0.35);
  g_VVVh_CMS_common_observed_noScale.kill.push_back(0.79);
  g_VVVh_CMS_common_observed_noScale.kill.push_back(0.81);
  g_VVVh_CMS_common_observed_noScale.kill.push_back(0.89);
  g_VVVh_CMS_common_observed_noScale.kill.push_back(0.93);
  ...
  g_VVVh_CMS_float_observed.file_name = "/uscms_data/d2/kreis/junFreeze/VVVh_CMS_float_observed_minuit_0p005_tries5_strategy0.combine.root";
  g_VVVh_CMS_float_observed.kill.push_back(0.68);
  g_VVVh_CMS_float_observed.kill.push_back(0.73);
  g_VVVh_CMS_float_observed.kill.push_back(0.79);
  g_VVVh_CMS_float_observed.kill.push_back(0.81);
  ...
  g_VVVh_CMS_common_observed.gr->Draw("LP");
  //g_VVVh_CMS_common_observed.gr->Fit("pol9");

  TGraphSmooth *gs = new TGraphSmooth("normal");
  //TGraph* grout = gs->SmoothKern(g_VVVh_CMS_common_observed.gr,"normal",5.0);//kernel
  //TGraph* grout = gs->SmoothSuper(g_VVVh_CMS_common_observed.gr,"",0,0);//super
  TGraph* grout = gs->SmoothSuper(g_VVVh_CMS_common_observed.gr,"",5);//super
  //TGraph* grout = gs->SmoothLowess(g_VVVh_CMS_common_observed.gr,"",0.2);
  grout->Draw("LPX");

  //TSpline *s = new TSpline3("grs",g_VVVh_CMS_common_observed.gr);
